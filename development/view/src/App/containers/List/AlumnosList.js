        ...
        return (   
            <Aux >
                ...
                <Modal show={this.state.open} onHide={this.closePDFmodal}
                    ...
                    <Modal.Title>Concentrado de participantes</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        {
                            this.props.alumnos.length > 0 ? <ListConcentradoUsuarios data={this.props.alumnos} type="alumnos"></ListConcentradoUsuarios> :  
                ...
                <Row className="header-container">                                                                           
                    <Col  xs="6" sm="3" className="header-new-format">PARTICIPANTES </Col>
...
//connect(props variable,props.functions reducers);
  export default withRouter(connect(mapStateToProps, mapDispatchToProps )(AlumnosList));
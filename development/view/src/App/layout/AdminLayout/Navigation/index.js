...
const mapStateToProps = state => {
    return {
        layout: state.menuReducer.layout,
        preLayout: state.menuReducer.preLayout,
        collapseMenu: state.menuReducer.collapseMenu,
        layoutType: state.menuReducer.layoutType,
        navBackColor: state.menuReducer.navBackColor,
        navBackImage: state.menuReducer.navBackImage,
        navIconColor: state.menuReducer.navIconColor,
        navBrandColor: state.menuReducer.navBrandColor,
        layout6Background: state.menuReducer.layout6Background,
        layout6BackSize: state.menuReducer.layout6BackSize,
        rtlLayout: state.menuReducer.rtlLayout,
        navFixedLayout: state.menuReducer.navFixedLayout,
        boxLayout: state.menuReducer.boxLayout,
        navDropdownIcon: state.menuReducer.navDropdownIcon,
        navListIcon: state.menuReducer.navListIcon,
        navActiveListColor: state.menuReducer.navActiveListColor,
        navListTitleColor: state.menuReducer.navListTitleColor,
        navListTitleHide: state.menuReducer.navListTitleHide
    }
};
